...
// ══════════════════════════════════════════════════════════════
// MASTER PANEL MINIMIZE / COLLAPSE + DRAG (mobile)
// ══════════════════════════════════════════════════════════════
(function() {
  ...
  // Drag to reposition (mobile, finger or mouse)
  ...
  if (mpHead) {
    ...
    mpHead.addEventListener('touchstart', e => {
...
(function() {
  ...
  maxBtn.addEventListener('click', e => {
    ...
    if (maximized) {
      ...
      maxBtn.title = '還原';
      togBtn.textContent = '▼';  // collapse btn still useful when maximized
